...
router.get('/get_one/:id([0-9]+)', authMiddleware, adminMiddleware, UnitController.getOne);
...
router.delete('/delete/:id([0-9]+)', authMiddleware, adminMiddleware, UnitController.delete);
